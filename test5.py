...
from ffa6 import ForegroundFeatureAveragingWithAttention  # Import the updated model with MiDaS

# Initialize device and model
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
foreground_model = ForegroundFeatureAveragingWithAttention(device=device)  # Use the updated model with MiDaS
