...
from foreground_feature_averaging import ForegroundFeatureAveraging


# Initialize device and model
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
foreground_model = ForegroundFeatureAveraging(device=device)
...
def compute_cosine_similarity(img1, img2):
    ...
    # Get feature vectors using the ForegroundFeatureAveraging model
...
if __name__ == "__main__":
    folder_path = 'CUTE/apple/instance_1/in_the_wild/'  # Path to the folder "f" containing 4 images
